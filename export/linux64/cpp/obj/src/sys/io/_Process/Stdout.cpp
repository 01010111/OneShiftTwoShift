...
{
HX_STACK_FRAME("sys.io._Process.Stdout","new",0xc765a8f4,"sys.io._Process.Stdout.new","/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",64,0xc8ab0a78)
HX_STACK_THIS(this)
HX_STACK_ARG(p,"p")
...
int Stdout_obj::readByte( ){
	HX_STACK_FRAME("sys.io._Process.Stdout","readByte",0xa72b886a,"sys.io._Process.Stdout.readByte","/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",70,0xc8ab0a78)
	HX_STACK_THIS(this)
	HX_STACK_LINE(71)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
	HX_STACK_FRAME("sys.io._Process.Stdout","readBytes",0x9eebd4c9,"sys.io._Process.Stdout.readBytes","/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",76,0xc8ab0a78)
	HX_STACK_THIS(this)
