...
::Sys_obj::__register();
::zerolib::ZMath_obj::__register();
::zerolib::ZCountDown_obj::__register();
::zerolib::ZBitmapText_obj::__register();
...
::Type_obj::__register();
::Track_obj::__register();
::StringTools_obj::__register();
::StringBuf_obj::__register();
::Ship_obj::__register();
::Reflect_obj::__register();
::PoofPart_obj::__register();
