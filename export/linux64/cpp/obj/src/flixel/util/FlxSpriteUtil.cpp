		...
		HX_STACK_LINE(76)
		{
			...
			if ((tmp6)){
				...
				HX_STACK_LINE(76)
				{
					...
					HX_STACK_LINE(76)
					::String tmp8 = (HX_HCSTRING("Could not find a BitmapData asset with ID '","\x5f","\x79","\xa9","\x21") + id);		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(76)
					::String tmp9 = (tmp8 + HX_HCSTRING("'.","\x27","\x22","\x00","\x00"));		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(76)
