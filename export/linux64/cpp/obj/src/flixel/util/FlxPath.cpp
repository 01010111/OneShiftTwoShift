...
{
		HX_STACK_FRAME("flixel.util.FlxPath","drawDebug",0x7c3a9bfe,"flixel.util.FlxPath.drawDebug","flixel/util/FlxPath.hx",613,0x22aae741)
		HX_STACK_THIS(this)
		...
		while((true)){
			...
			HX_STACK_LINE(644)
			::flixel::math::FlxPoint tmp8 = this->nodes->__get(i).StaticCast< ::flixel::math::FlxPoint >();		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(644)
			node = tmp8;
			HX_STACK_LINE(647)
			...
			if ((tmp41)){
				...
				HX_STACK_LINE(679)
				::flixel::math::FlxPoint tmp43 = this->nodes->__get(tmp42).StaticCast< ::flixel::math::FlxPoint >();		HX_STACK_VAR(tmp43,"tmp43");
				HX_STACK_LINE(679)
				nextNode = tmp43;
			}
			else{
				HX_STACK_LINE(683)
				::flixel::math::FlxPoint tmp42 = this->nodes->__get(i).StaticCast< ::flixel::math::FlxPoint >();		HX_STACK_VAR(tmp42,"tmp42");
				HX_STACK_LINE(683)
				nextNode = tmp42;
			}
			HX_STACK_LINE(687)
