...
Array< ::Dynamic > FlxArrayUtil_obj::fastSplice_flixel_system_debug_Window( Array< ::Dynamic > array,::flixel::_system::debug::Window element){
	HX_STACK_FRAME("flixel.util.FlxArrayUtil","fastSplice_flixel_system_debug_Window",0x3304bcc5,"flixel.util.FlxArrayUtil.fastSplice_flixel_system_debug_Window","flixel/util/FlxArrayUtil.hx",45,0xa0dc755b)
	HX_STACK_ARG(array,"array")
...
Array< ::Dynamic > FlxArrayUtil_obj::fastSplice_flixel_system_debug_watch_WatchEntry( Array< ::Dynamic > array,::flixel::_system::debug::watch::WatchEntry element){
	HX_STACK_FRAME("flixel.util.FlxArrayUtil","fastSplice_flixel_system_debug_watch_WatchEntry",0xa8936be8,"flixel.util.FlxArrayUtil.fastSplice_flixel_system_debug_watch_WatchEntry","flixel/util/FlxArrayUtil.hx",45,0xa0dc755b)
	HX_STACK_ARG(array,"array")
	HX_STACK_ARG(element,"element")
	HX_STACK_LINE(46)
