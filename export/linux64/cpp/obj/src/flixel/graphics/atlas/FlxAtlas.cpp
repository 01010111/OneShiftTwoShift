...
::flixel::graphics::atlas::FlxNode FlxAtlas_obj::addNode( Dynamic Graphic,::String Key){
	...
	if ((tmp9)){
		HX_STACK_LINE(178)
		Dynamic tmp10 = Graphic;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(178)
		::String tmp11 = ::Std_obj::string(tmp10);		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(178)
		::String tmp12 = (HX_HCSTRING("addNode can't find bitmapdata with specified key: ","\xbb","\x33","\x14","\x9a") + tmp11);		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(178)
		::String tmp13 = (tmp12 + HX_HCSTRING(". Please provide valid value.","\x84","\xe6","\x88","\x32"));		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(178)
...
::flixel::graphics::frames::FlxTileFrames FlxAtlas_obj::addNodeWithSpacesAndBorders( Dynamic Graphic,::String Key,::flixel::math::FlxPoint tileSize,::flixel::math::FlxPoint tileSpacing,::flixel::math::FlxPoint tileBorder,::flixel::math::FlxRect region){
	...
	if ((tmp16)){
		HX_STACK_LINE(603)
		Dynamic tmp17 = Graphic;		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(603)
		::String tmp18 = ::Std_obj::string(tmp17);		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(603)
		::String tmp19 = (HX_HCSTRING("addNodeWithSpacings can't find bitmapdata with specified key: ","\x25","\x03","\x32","\x92") + tmp18);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(603)
		::String tmp20 = (tmp19 + HX_HCSTRING(". Please provide valid value.","\x84","\xe6","\x88","\x32"));		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(603)
	...
	if ((tmp26)){
		...
		HX_STACK_LINE(614)
		::String tmp29 = (HX_HCSTRING("addNodeWithSpacings can't insert provided image: ","\xa1","\x49","\x3a","\x35") + tmp28);		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(614)
		::String tmp30 = (tmp29 + HX_HCSTRING(") in atlas. It's probably too big.","\xa7","\x39","\x69","\x92"));		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(614)
