...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(333)
		{
			...
			HX_STACK_LINE(333)
			tmp29->__Field(HX_HCSTRING("preGameReset","\xda","\x1b","\xe3","\xc1"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
			HX_STACK_LINE(333)
			...
			HX_STACK_LINE(333)
			::flixel::_system::frontEnds::SignalFrontEnd tmp35 = ::flixel::FlxG_obj::signals;		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(333)
			tmp35->__Field(HX_HCSTRING("postGameReset","\xfd","\x07","\x96","\xc9"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
		}
		HX_STACK_LINE(334)
		this->switchState();
		HX_STACK_LINE(336)
		...
		HX_STACK_LINE(336)
		int tmp30 = ::flixel::FlxG_obj::drawFramerate;		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(336)
		bool tmp31 = (tmp29 < tmp30);		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(336)
		if ((tmp31)){
			HX_STACK_LINE(338)
			::flixel::_system::frontEnds::LogFrontEnd tmp32 = ::flixel::FlxG_obj::log;		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(338)
			::flixel::_system::debug::log::LogStyle tmp33 = ::flixel::_system::debug::log::LogStyle_obj::WARNING;		HX_STACK_VAR(tmp33,"tmp33");
			HX_STACK_LINE(338)
			tmp32->__Field(HX_HCSTRING("advanced","\xa2","\x69","\x7b","\x3b"), hx::paccDynamic )(HX_HCSTRING("FlxG.updateFramerate: The update framerate shouldn't be smaller than the draw framerate, since it can slow down your game.","\x81","\x2e","\x69","\x6b"),tmp33,true);
		}
		HX_STACK_LINE(342)
		...
		HX_STACK_LINE(342)
		Dynamic tmp34 = this->onEnterFrame_dyn();		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(342)
		...
		HX_STACK_LINE(346)
		::String tmp36 = ::openfl::_legacy::events::Event_obj::RESIZE;		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(346)
		Dynamic tmp37 = this->onResize_dyn();		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(346)
		...
		HX_STACK_LINE(349)
		int tmp40 = tmp39->get_stageWidth();		HX_STACK_VAR(tmp40,"tmp40");
		HX_STACK_LINE(349)
		...
		HX_STACK_LINE(349)
		int tmp43 = tmp42->get_stageHeight();		HX_STACK_VAR(tmp43,"tmp43");
		HX_STACK_LINE(349)
		this->resizeGame(tmp40,tmp43);
		HX_STACK_LINE(351)
		::String tmp44 = ::openfl::_legacy::events::Event_obj::CHANGE;		HX_STACK_VAR(tmp44,"tmp44");
		HX_STACK_LINE(351)
		::flixel::_system::frontEnds::BitmapFrontEnd tmp45 = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(tmp45,"tmp45");
		HX_STACK_LINE(351)
		Dynamic tmp46 = tmp45->__Field(HX_HCSTRING("onAssetsReload","\xfb","\x33","\x88","\x63"), hx::paccDynamic );		HX_STACK_VAR(tmp46,"tmp46");
		HX_STACK_LINE(351)
		::openfl::_legacy::Assets_obj::addEventListener(tmp44,tmp46,null(),null(),null());
	}
return null();
}
...
Void FlxGame_obj::onEnterFrame( Dynamic _){
{
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(544)
			int tmp17 = ::flixel::FlxBasic_obj::visibleCount;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(544)
...
Void FlxGame_obj::update( ){
{
		...
		if ((tmp12)){
			...
			Float tmp13 = ::flixel::FlxG_obj::timeScale;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(724)
			Float tmp14 = this->_elapsedMS;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(724)
		...
		if ((tmp14)){
			HX_STACK_LINE(736)
			::flixel::effects::postprocess::PostProcess tmp15 = this->postProcesses->__get((int)0).StaticCast< ::flixel::effects::postprocess::PostProcess >();		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(736)
		...
		Float tmp16 = ::flixel::FlxG_obj::elapsed;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(741)
		tmp15->__Field(HX_HCSTRING("update","\x09","\x86","\x05","\x87"), hx::paccDynamic )(tmp16);
		HX_STACK_LINE(743)
		{
			HX_STACK_LINE(743)
			...
			HX_STACK_LINE(743)
			{
				...
				int _g = (int)0;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(743)
				::flixel::_system::frontEnds::PluginFrontEnd tmp18 = ::flixel::FlxG_obj::plugins;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(743)
				...
				while((true)){
					...
					HX_STACK_LINE(743)
					::flixel::FlxBasic tmp21 = _g1->__get(_g).StaticCast< ::flixel::FlxBasic >();		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(743)
					::flixel::FlxBasic plugin = tmp21;		HX_STACK_VAR(plugin,"plugin");
					HX_STACK_LINE(743)
					++(_g);
					HX_STACK_LINE(743)
					bool tmp22 = plugin->exists;		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(743)
		...
		HX_STACK_LINE(745)
		tmp17->tryUpdate(tmp18);
		HX_STACK_LINE(747)
		{
			HX_STACK_LINE(747)
			Float tmp19 = ::flixel::FlxG_obj::elapsed;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(747)
			Float elapsed = tmp19;		HX_STACK_VAR(elapsed,"elapsed");
			HX_STACK_LINE(747)
			{
				HX_STACK_LINE(747)
				int _g = (int)0;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(747)
				::flixel::_system::frontEnds::CameraFrontEnd tmp20 = ::flixel::FlxG_obj::cameras;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(747)
				Array< ::Dynamic > _g1 = tmp20->__Field(HX_HCSTRING("list","\x5e","\x1c","\xb3","\x47"), hx::paccDynamic );		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(747)
				while((true)){
					HX_STACK_LINE(747)
					...
					HX_STACK_LINE(747)
					::flixel::FlxCamera tmp23 = _g1->__get(_g).StaticCast< ::flixel::FlxCamera >();		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(747)
					::flixel::FlxCamera camera = tmp23;		HX_STACK_VAR(camera,"camera");
					HX_STACK_LINE(747)
					++(_g);
					HX_STACK_LINE(747)
					bool tmp24 = (camera != null());		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(747)
					...
					if ((tmp27)){
						HX_STACK_LINE(747)
						Float tmp28 = elapsed;		HX_STACK_VAR(tmp28,"tmp28");
						HX_STACK_LINE(747)
						camera->update(tmp28);
					}
				}
		...
		HX_STACK_LINE(748)
		::flixel::_system::frontEnds::SignalFrontEnd tmp19 = ::flixel::FlxG_obj::signals;		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(748)
		tmp19->__Field(HX_HCSTRING("postUpdate","\x89","\x06","\x3e","\xdc"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
		HX_STACK_LINE(751)
		::flixel::_system::debug::FlxDebugger tmp20 = this->debugger;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(751)
		int tmp21 = this->getTimer();		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(751)
		int tmp22 = this->ticks;		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(751)
		int tmp23 = (tmp21 - tmp22);		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(751)
		tmp20->__Field(HX_HCSTRING("stats","\x1f","\x76","\x0b","\x84"), hx::paccDynamic )->__Field(HX_HCSTRING("flixelUpdate","\x85","\x69","\x5e","\x27"), hx::paccDynamic )(tmp23);
		HX_STACK_LINE(755)
		{
			HX_STACK_LINE(755)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
			...
			while((true)){
				...
				HX_STACK_LINE(755)
				::flixel::input::FlxSwipe tmp26 = _g1->__get(_g).StaticCast< ::flixel::input::FlxSwipe >();		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(755)
				::flixel::input::FlxSwipe swipe = tmp26;		HX_STACK_VAR(swipe,"swipe");
				HX_STACK_LINE(755)
				++(_g);
				HX_STACK_LINE(757)
				swipe = null();
		...
		HX_STACK_LINE(762)
		bool tmp24 = this->filtersEnabled;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(762)
		this->set_filters((  ((tmp24)) ? Array< ::Dynamic >(this->_filters) : Array< ::Dynamic >(null()) ));
	}
return null();
}
...
Void FlxGame_obj::draw( ){
{
		...
		HX_STACK_LINE(876)
		int tmp17 = this->ticks;		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(876)
		int tmp18 = (tmp16 - tmp17);		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(876)
		tmp15->__Field(HX_HCSTRING("stats","\x1f","\x76","\x0b","\x84"), hx::paccDynamic )->__Field(HX_HCSTRING("flixelDraw","\x80","\xf8","\xdf","\x4d"), hx::paccDynamic )(tmp18);
	}
return null();
}
