	...
	HX_STACK_ARG(Name,"Name")
{
		...
		HX_STACK_LINE(11)
		::flixel::_system::debug::log::BitmapLog tmp1 = tmp->debugger->__Field(HX_HCSTRING("bitmapLog","\xd5","\x5b","\xdb","\xc6"), hx::paccDynamic );		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(11)
...
Void BitmapLogFrontEnd_obj::viewCache( ){
{
		...
		HX_STACK_LINE(43)
		for(::cpp::FastIterator_obj< ::flixel::graphics::FlxGraphic > *__it = ::cpp::CreateFastIterator< ::flixel::graphics::FlxGraphic >(tmp1);  __it->hasNext(); ){
			::flixel::graphics::FlxGraphic cachedGraphic = __it->next();
			{
				HX_STACK_LINE(45)
				::flixel::FlxGame tmp2 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(45)
				::flixel::_system::debug::log::BitmapLog tmp3 = tmp2->debugger->__Field(HX_HCSTRING("bitmapLog","\xd5","\x5b","\xdb","\xc6"), hx::paccDynamic );		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(45)
