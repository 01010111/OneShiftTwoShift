		...
		if ((tmp12)){
			...
			if ((tmp13)){
				...
				if ((tmp15)){
					...
					HX_STACK_LINE(80)
					tmp18->__Field(HX_HCSTRING("play","\xf4","\x2d","\x5a","\x4a"), hx::paccDynamic )(null());
				}
			}
			HX_STACK_LINE(85)
			...
			if ((tmp14)){
				...
				if ((tmp16)){
					...
					HX_STACK_LINE(87)
					tmp18->set_stageFocusRect(false);
					HX_STACK_LINE(87)
					...
					HX_STACK_LINE(87)
					tmp20->set_focus(tmp21);
				}
				HX_STACK_LINE(87)
				::flixel::_system::frontEnds::DebuggerFrontEnd tmp17 = ::flixel::FlxG_obj::debugger;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(87)
				tmp17->__FieldRef(HX_HCSTRING("visible","\x72","\x78","\x24","\xa3")) = true;
			}
			HX_STACK_LINE(90)
