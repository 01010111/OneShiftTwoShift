...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "OneShiftTwoShift", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "OneShiftTwoShift";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "OneShiftTwoShift", null, { width: 512, height: 512 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 512, 512, "null");
		#end
		#else
		create ();
		#end
